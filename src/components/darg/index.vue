<template>
  <div class="mobile" @click="goWeb2('common#/Download')" @touchstart="starts($event)" @touchmove.prevent="move($event)"
    @touchend="moveup($event)" :style="currentBtnStyle" v-if="showBtnStore.key != 'false'">
